'use strict';
innoApp
  .controller('metabCtrl', ["$scope", "AuthService","ajaxFactory", function($scope, AuthService, ajaxFactory) {
    $scope.role = AuthService.getRole();
    $scope.tab = 'endocrinology';
    $scope.$parent.active = 'GH';
    $scope.loading=true;
    ...
    $scope.$watch('filterObj', function() {
      ...
      filterdata().then(function(filterResults) {
        ...
        var medata = function() {
          return ajaxFactory.getData("/v1/sales/ta", "post","json", {"ta":"ME", "filters" : $scope.filterObj},null);
        }
        medata().then(function(res) {
          ...
          var salesperformancemedata = function() {
            return ajaxFactory.getData("/v1/sales/company/salesperformance", "post", "json",{"ta":"ME", "filters" : $scope.filterObj},null);
          }
          salesperformancemedata().then(function(res) {
